...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        public IActionResult ObterTodos()
        {
            ...
            // TODO: Validar o tipo de retorno. Se não encontrar tarefas, retornar NotFound,
        ...
        public IActionResult ObterPorTitulo(string titulo)
        {
            ...
            tarefas = _context.Tasks.Where(x => x.Titulo == titulo).ToList();
        ...
        {
            var tarefa = _context.Tasks.Where(x => x.Data.Date == data.Date);
        ...
        public IActionResult Atualizar(int id, Tarefa tarefa)
        {
            ...
            return Ok($"Tarefa número {id}, atualizada com sucesso!");
        }
